...
import { Transaction,PaginatedRequestParams, RequestByEmployeeParams, SetTransactionApprovalParams } from "./types"
  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      switch (endpoint) {
        ...
        case "clients":
          result = getClients() as unknown as TData
          console.log(result)
          setTimeout(() => {
            mockApiLogger({ data: { endpoint, params, result } })
            resolve(result)
        ...
        case "paginatedTransactions":
          result = getTransactionsPaginated(params as PaginatedRequestParams<Transaction[]>) as unknown as TData
